...
public  class  ESEXEC {
    ...
    static {
        ...
        JSONObject ctdn_investfirms = JSONObject.parseObject("{ \"mappings\" : { \"investfirms\": { \"properties\": { \"orgId\":{ \"type\": \"long\" },\"investRounds\":{ \"type\": \"keyword\" }, \"code\":{ \"type\": \"long\" }, \"industryIds\":{ \"type\": \"keyword\" },  \"investStage\":{ \"type\": \"keyword\" }, \"orgType\":{ \"type\": \"keyword\" }, \"districtId\":{ \"type\": \"long\" }, \"districtSubId\":{ \"type\": \"long\" }, \"capitalType\":{ \"type\":\"keyword\" }, \"currencyType\":{ \"type\": \"keyword\" }, \"logoSmall\":{ \"type\": \"keyword\" }, \"investOrg\":{ \"type\": \"keyword\" }, \"investTotal\":{ \"type\": \"integer\" }, \"totalRatio\":{ \"type\": \"integer\" }, \"investAmountNum\":{ \"type\": \"long\" }, \"investAmountStr\":{ \"type\": \"keyword\" }, \"amountRatio\":{ \"type\": \"integer\" }, \"investProj\":{ \"type\": \"keyword\" }, \"newestInvestDate\":{ \"type\": \"date\" } } } } }");
