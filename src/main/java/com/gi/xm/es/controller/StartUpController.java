...
public class StartUpController {
    ...
    @RequestMapping(value = "startUp", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseBody
    public MessageInfo4ES queryStartUp(@RequestBody StartUpQuery query) {
