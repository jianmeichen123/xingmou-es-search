...
public class MultiSearchController {
    ...
    @ResponseBody
    public Result searchByKey(String keys,@RequestHeader (name = "userInfo" ,required = false) String userInfo ,  @RequestBody Query query) throws ClassNotFoundException {
