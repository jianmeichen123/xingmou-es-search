...
public class LaunchEventController {
    ...
    public Result queryInvestEvent(@RequestBody LaunchEventQuery launchEventQuery) {
        ...
        if(launchEventQuery.getOrder() != null){
